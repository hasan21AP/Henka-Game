    ...
    return NestedScrollView(
      headerSliverBuilder: (context, innerBoxIsScrolled) => [
        SliverAppBar(
          ...
          floating: false,
          snap: false,
          expandedHeight: 100, // ارتفاع الـ AppBar عند عدم التمرير
              ...
              children: [
                ...
                GridView.builder(
                  ...
                  gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                    crossAxisCount:
                        4, // عدد الأعمدة (يمكنك تغييره إلى 3 لجعل البطاقات أصغر)
                    ...
                    return GestureDetector(
                      onTap: () {
                        ...
                        if (!isSelected &&
                          ...
                          controller.selectedCategories[category] = !isSelected;
                        }
                      },
                      child: Obx(
                        () => Container(
